/* ============================================================
   CARMON TRADEGAR · Blog / Informes on-chain · GENERADOR DINÁMICO
    ...
    <div className="fade-in">
      ...
      <article id="blog-article" style={{ maxWidth: 1000 }}>
        ...
        <div className="tiny muted" style={{ margin: "20px 2px 0", lineHeight: 1.5 }}>
          Informe generado por el modelo Carmon Tradegar sobre métricas públicas on-chain · periodo {fmtDia(r.startIso)} – {fmtDia(r.endIso)}. No constituye asesoramiento financiero ni recomendación de inversión.
        </div>
      </article>
    </div>
  );
