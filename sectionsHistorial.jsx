/* ============================================================
   CARMON TRADEGAR · Historial de resúmenes diarios (desde 2017)
   Reconstruye, para cada día, la lectura que Carmon Tradegar habría dado:
    ...
    <div className="fade-in">
      <div className="page-head" style={{ display: "flex", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
        <div style={{ flex: 1, minWidth: 260 }}>
          <h1>Historial de lecturas <HelpDot term="Historial de lecturas diarias" def="Para cada día desde 2017, Carmon Tradegar reconstruye con los datos reales de ese día qué lectura habría dado: la temperatura de corto (STH) y de largo plazo (LTH), la zona y el veredicto (acumular, mantener, reducir o distribuir). Sirve para dos cosas: ver con tus propios ojos que el modelo marcaba zonas frías en los suelos y calientes en los techos, y repasar qué decía el sistema el día que tú compraste o vendiste." /></h1>
          <p>Qué habría dicho Carmon Tradegar cada día, con los datos de ese día · desde 1 de enero de 2017</p>
        </div>
