/* ============================================================
   CARMON TRADEGAR · Preguntas por activo y horizonte
...
function SectionPreguntas({ results, regime, palette, onGo, k }) {
  ...
  return (
    <div className="fade-in">
      ...
      <Card title="La escala de Carmon Tradegar" sub="Una sola cifra de 0 a 100 · cortes fijos, iguales para BTC y ETH y para los dos horizontes" style={{ marginTop: 16 }}>
