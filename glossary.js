/* ============================================================
   CARMON TRADEGAR · Glosario de métricas (explicaciones sencillas)
...
(function () {
  ...
  window.BambuGlossary = {
    ...
    indice:  { term: "Índice Carmon", def: "Número de −100 a +100 que resume todas las métricas del horizonte. Positivo y verde = momento de acumular; negativo y rojo = momento de distribuir; cerca de 0 = neutral." },
