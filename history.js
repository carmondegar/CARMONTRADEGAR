/* ============================================================
   CARMON TRADEGAR · Histórico diario sintético (90 días)
...
(function () {
  ...
  try { window.BambuDataDate = "2026-08-30"; window.BambuDataTime = "13:00 UTC"; } catch (e) {}
  ...
  /* ----- bandas y percentiles calibrados con la historia completa -----
     Todas las gráficas de temperatura de Carmon Tradegar usan esta misma calibración:
     las bandas nacen de la distribución real del activo (decil frío / decil
     caliente), no de cortes fijos 0-100. */
  /* Escala publicada de Carmon Tradegar: la temperatura se expresa como su POSICION en la
