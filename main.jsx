/* ============================================================
   CARMON TRADEGAR · App shell + navegación + Tweaks
   ============================================================ */
...
const NAVGROUPS = [
  ...
  { label: "Ayuda", items: [
    { id: "guia",     label: "Cómo usar Carmon Tradegar", icon: "guia" },
  ]},
];
const TITLES = {
  ...
  guia:    ["Cómo usar Carmon Tradegar", "Guía de uso sencilla, paso a paso"],
};
...
const SECTION_HELP = {
  ...
  guia: "Guía de uso paso a paso, en lenguaje sencillo: qué es Carmon Tradegar, los 3 colores clave y cómo tomar una decisión en 6 pasos. Ideal para empezar.",
};
    ...
    <div className={"app" + (t.density === "compact" ? " dense" : "") + (navOpen ? " nav-open" : "")}>
      ...
      <aside className="sidebar">
        <div className="brand">
          <BrandMark />
          <div>
            <div className="brand-name">Carmon Tradegar +</div>
        ...
        <div className="nav-foot">
          Modelo de scoring Carmon Tradegar<br /><br />
      ...
      <div className="main">
        <header className="topbar">
          ...
          <div className="tb-title">{(TITLES[page] || ["Carmon Tradegar", ""])[0]}{SECTION_HELP[page] && <HelpDot term={(TITLES[page] || ["Carmon Tradegar"])[0]} def={SECTION_HELP[page]} />}<small>{(TITLES[page] || ["", ""])[1]}</small></div>
